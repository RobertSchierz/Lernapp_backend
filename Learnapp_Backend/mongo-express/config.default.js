...
module.exports = {
  mongodb: {
    ...
    adminUsername: process.env.ME_CONFIG_MONGODB_ADMINUSERNAME || 'learnapp_mongoadmin',
    adminPassword: process.env.ME_CONFIG_MONGODB_ADMINPASSWORD || 'Xahy4ozuje',
  ...
  site: {
    ...
    port:             process.env.VCAP_APP_PORT                 || 64321,
